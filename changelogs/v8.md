...
# 📥 Changelog for v8.6.0.0 from --.03.2025 <!-- {#ver-860} -->
First update of 2025! After the update, you will need to reconfigure the FPS Unlocker.

## Translations
This update introduces the ability to translate Stella Mod into different languages!
If you want to translate Stella Mod into your native language, click [here](https://crowdin.com/project/genshin-stella-mod).
...
6. Added new translations:
   - **Français** (French) - 26% (credits: [Nikodim](https://crowdin.com/profile/nikodim))
   - **Türkçe** (Turkish) - 100% (credits: [majorcanel](https://crowdin.com/profile/majorcanel), [MahmutAbi](https://crowdin.com/profile/mahmutabi))
   - **Русский** (Russian) - 73% (credits: [Ronner231](https://crowdin.com/profile/ronner231), [FanHamMer](https://crowdin.com/profile/fanhammer), [FL1IP](https://crowdin.com/profile/fl1ip))
   - **Svenska** (Swedish) – 100% (credits: [OmegaBrony](https://crowdin.com/profile/omegabrony))
7. Polish translation improvements.
8. Removed some unnecessary files.
9. Changed the structure of some files/folders.
10. Deployed one new [honeypot](https://en.wikipedia.org/wiki/Honeypot_(computing)).
