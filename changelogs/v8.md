...
3. Added new translations:
   - Portuguese (Brazil) – 100% (credits: [micklod](https://crowdin.com/profile/micklod))
4. Improved the language selection window.
5. Security system has been improved.
6. API v7 has been deprecated and will no longer function.
7. Enhanced the visual design of the FPS Unlocker.
8. FPS Unlocker is now translatable into multiple languages through Crowdin.
