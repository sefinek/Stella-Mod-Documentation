...
2. Updated the following translations:
   - **NEW!** Italian (to be added soon) (thanks [ThaWalife](https://crowdin.com/profile/ThaWalife), [Rytheex](https://crowdin.com/profile/Rytheex))
   - Polish (official translations)
   - Russian (thanks [Blueberryy](https://crowdin.com/profile/blueberryy), [Speech100](https://crowdin.com/profile/speech100))
   - Swedish (thanks [Omega Brony](https://crowdin.com/profile/omegabrony))
   - Turkish (thanks [MajorCanel](https://crowdin.com/profile/majorcanel))
   - Chinese (Simplified) (not available yet) (thanks [duck-studio](https://crowdin.com/profile/duck-studio))
3. Several English strings improved for better fluency.
