...
2. Updated translations:
   - Polish – 100% (official translations)
   - Turkish – 98% (thanks [majorcanel](https://crowdin.com/profile/majorcanel))
   - Swedish – 98% (thanks [OmegaBrony](https://crowdin.com/profile/omegabrony))
   - Russian (Русский) – 98% (thanks [flawox](https://crowdin.com/profile/flawox), [FL1IP](https://crowdin.com/profile/fl1ip))
   - Portuguese (Brazil) – 91% (thanks [micklod](https://crowdin.com/profile/micklod))
...
2. **NEW!** FPS Unlocker is now translatable into multiple languages through Crowdin.
