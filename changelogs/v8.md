...
3. The application will now terminate the following processes: `GenshinImpact`, `YuanShen`, `HYP`.
4. The application will now continuously terminate the `loader.exe` process.
