...
# 📥 Changelog for v8.-.-.- from --.04.2025
## Miscellaneous
1. Updated translations:
   - Turkish (thanks [majorcanel](https://crowdin.com/profile/majorcanel))
   - Swedish (thanks [OmegaBrony](https://crowdin.com/profile/omegabrony))
2. Finished translations:
   - Russian (Русский) – 100% (thanks [flawox](https://crowdin.com/profile/flawox), [FL1IP](https://crowdin.com/profile/fl1ip))
3. Added new translations:
   - Portuguese (Brazil) – 100% (thanks [micklod](https://crowdin.com/profile/micklod))
4. Security system has been improved.
5. API v7 has been deprecated and will no longer function.

## Stella Mod Launcher
1. Improved the language selection window.
2. Added the ability to change the appearance of Moecounter.
3. Other minor fixes.
...
2. FPS Unlocker is now translatable into multiple languages through Crowdin.
