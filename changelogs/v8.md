...
# 📥 Changelog for v8.7.-.- from --.--.2025 (not released yet)
...
4. Updated the following translations:
   - **NEW!** Italian (coming soon) (thanks to [ThaWalife](https://crowdin.com/profile/ThaWalife), [Rytheex](https://crowdin.com/profile/Rytheex))
...
5. Improved many English phrases to be smoother and more readable.
6. Updated InnoSetup to the latest version.
7. Updated Windows Terminal to the latest version.
8. Fixed several WebSocket communication issues.
9. Improved the changelog window shown after each update – the previous one was crappy.

## FPS Unlocker
1. Updated `Microsoft.Extensions.DependencyInjection` to the latest version.
2. Updated translations for Italian, Swedish, Russian.
3. Migrated to .NET 9.
