...
# 📥 Changelog for v8.8.0.0 from 10.09.2025 <!-- {#ver-880} -->
...
5. **NEW!** Added hotkeys.
6. On the first launch, the application automatically sets the FPS limit based on the refresh rate of the primary monitor.
7. In the settings, the application displays a list of monitors along with their names, resolutions, and refresh rates.
