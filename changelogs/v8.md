...
4. Improved integration with `WebView2`.
...
10. Ustawiono `webView21.Dock` na wartość `Fill` w oknie `Browser`.
11. Zwiększono rozmiar okna przeglądarki z listą zmian Genshin Stella Mod.
