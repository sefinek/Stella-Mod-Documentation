...
8. Fixed an issue where the YouTube player in the `Gameplay window` was throwing error 153.
9. Corrected the year from 2025 to 2026 in certain cases.
10. Set `webView21.Dock` to `Fill` in the `Browser` window.
11. Increased the size of the changelog browser window.
