...
# 📥 Changelog for v8.3.2.0 from 24.10.2024 <!-- {#ver-832} -->
1. The counters displaying the number of online users have been disabled, as they were showing incorrect data. However, devices will still connect to the WebSocket.
2. Microsoft.Web.WebView2 has been updated to the latest version.
3. Other minor fixes have been implemented.
