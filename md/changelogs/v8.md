...
# 📥 Changelog for v8.3.2.0 from 06.11.2024 <!-- {#ver-832} -->
1. Resolved various bugs affecting the application's stability and overall functionality.
2. Fixed specific issues impacting Stella Plus subscribers.
3. Removed statistics counters in the bottom left corner of the application, as they were incorrect and could mislead users.
4. Updated Microsoft.Web.WebView2 and Cliwrap to their latest versions.
5. Changed my old nickname `sefinek24` to `sefinek` (reflecting the update to my GitHub profile).
6. Enhanced NLog configuration.
7. Implemented additional minor fixes and improvements to optimize app performance and improve user experience.
